...
/*   Updated: 2025/03/06 14:59:33 by yhossni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const char	*builtins[] = {"pwd", "PWD", "echo", "ECHO", "cd", "export",
		"unset", "env", "ENV", "exit", NULL};
	int			i;
